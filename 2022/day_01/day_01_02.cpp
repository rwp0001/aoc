...
by the various meals, snacks, 
rations, etc. that they've brought with them, one item per line. 
...
void ReadFile( std::string filename ) {
    ...
    Count = Data.back();
    Data.pop_back();
    std::cout << " 2: " << Data.back();
    Count += Data.back();
    Data.pop_back();
    std::cout << " 3: " << Data.back() << "\n";
    Count += Data.back();
